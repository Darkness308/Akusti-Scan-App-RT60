...
- 📊 **RT60-Berechnung** für verschiedene Frequenzbänder (125 Hz - 8 kHz)
- 📈 **Visualisierung** von Decay-Kurven und Frequenzspektren
- 💾 **Messhistorie** mit CoreData-Persistenz
- 📤 **Export** als CSV, JSON oder PDF
- 🌍 **Geo-Tagging** von Messungen (optional)
